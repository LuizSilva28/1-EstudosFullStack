...
})({"8okHc":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "c7115087e6392d2e";
"use strict";
...
},{}],"lBBEF":[function(require,module,exports,__globalThis) {
...
const phrases = [
    "A ambi\xe7\xe3o me impulsiona a alcan\xe7ar meus objetivos mais audaciosos.",
    "A assertividade \xe9 fundamental para defender minhas ideias e necessidades.",
    "A facilita\xe7\xe3o garante que os processos fluam de forma eficiente e colaborativa.",
    "A comunica\xe7\xe3o clara e eficaz \xe9 a chave para construir relacionamentos s\xf3lidos.",
    "A flexibilidade me permite adaptar-me a diferentes situa\xe7\xf5es e desafios.",
    "A influ\xeancia positiva inspira e motiva as pessoas ao meu redor.",
    "A iniciativa me leva a agir proativamente e buscar solu\xe7\xf5es inovadoras.",
    "A reflex\xe3o profunda me ajuda a tomar decis\xf5es mais conscientes e ponderadas.",
    "A sociabilidade me permite construir conex\xf5es significativas e ampliar minha rede.",
    "A capacidade anal\xedtica me permite identificar padr\xf5es e resolver problemas complexos.",
    "O pensamento conceitual me ajuda a compreender ideias abstratas e desenvolver novas teorias.",
    "O pensamento criativo me permite gerar solu\xe7\xf5es originais e inovadoras.",
    "O planejamento e organiza\xe7\xe3o me ajudam a alcan\xe7ar meus objetivos de forma eficiente.",
    "A considera\xe7\xe3o pelos outros demonstra empatia e respeito pelas diferen\xe7as.",
    "A estabilidade emocional me permite lidar com desafios de forma equilibrada e resiliente.",
    "A tomada de riscos calculados me leva a explorar novas oportunidades e alcan\xe7ar o sucesso."
];
/*
	{
...
*/ function scribePhrases(phrase) {
    ...
    function frame() {
        ...
        if (newText.length === text.length) clearInterval(id);
        newText += char;
...
(0, _chartJs.Tooltip).positioners.myCustomPositioner = function(elements, eventPosition) {
    const tooltip = this;
    return {
        x: 200,
        y: 800
    ...
    afterUpdate (chart, args, options) {
        ...
        items.forEach((item)=>{
            ...
            li.onclick = ()=>{
                ...
                if (type === "polarArea") chart.toggleDataVisibility(item.index);
                else chart.setDatasetVisibility(item.datasetIndex, !chart.isDatasetVisible(item.datasetIndex));
                chart.update();
            };
...
(async function() {
    ...
    const data = {
        labels: [
            ...
            "considera\xe7\xe3o pelos outros",
    ...
    const chart = new (0, _autoDefault.default)(graphicPolarAreaChart, {
        type: "polarArea",
        data: data,
        responsive: true,
...
},{"chart.js/auto":"d8NN9","chart.js":"ipU8D","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["8okHc","lBBEF"], "lBBEF", "parcelRequire94c2")

//# sourceMappingURL=index.e6392d2e.js.map
