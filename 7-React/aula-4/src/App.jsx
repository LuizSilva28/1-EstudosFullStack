...
function App() {
  ...
  <div>
    ...
    <div>
      ...
      <button>Rederências da API</button>
    </div>
    
    <hr />

    <h2>Crie interfaces de usuário de componentes</h2>
    <p>React permite que você construa interfaces de usuário a partir de pedaços individuas chamados de componentes.</p>
    <hr />

    <h2>Escreva componentes co código de marcação</h2>
    <p>Componentes React são funções JacaScript. A sintaxe de marcação é chamada de JSX. É uma extensão da sintaxe JavaScript popularizada pelo React.
    </p>
    <hr />
